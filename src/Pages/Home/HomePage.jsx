...
const images = [
  ...
  "http://13.127.97.224/images/pexels-kristya-nugraha-329778-5045090.jpg",
...
const HomePage = () => {
  ...
  const goToSlide = (index) => {
    if (index < 0) {
      setCurrentSlide(images.length - 1); // Loop to the last slide
        ...
        >
          {images.map((src, index) => (
            ...
            >
              ...
              {/* Heading Overlay */}
              {heading && (
                <h2 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-2xl font-bold bg-black bg-opacity-50 px-4 py-2 rounded">
                  {heading}
                </h2>
              )}
            </div>
